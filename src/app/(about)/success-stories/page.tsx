...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Истории успеха выпускников EasyUM в ${city}`,
		description: `Истории успеха учеников, окончивших курсы в школе программирования EasyUM по направлениям дизайн, программирование, маркетинг, тестирование, разработка игр и пр в ${city}`,
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Истории успеха выпускников EasyUM в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
