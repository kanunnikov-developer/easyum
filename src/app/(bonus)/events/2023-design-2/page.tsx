		...
		<section className={styles.page}>
			...
			<div className={'container'}>
				...
				<section className={styles.description}>
					<p>Дизайнер – креативная и творческая профессия, но со своими тонкостями и правилами. Если вы не знаете, изучать графический дизайн или веб-дизайн, или просто хотите понять, подойдет ли та профессия, которую вы выбрали – добро пожаловать на бесплатное пробное занятие.</p>
					<br />
					<p>Мы расскажем об особенностях работы дизайнером, подводных камнях профессии, навыках, инструментах и, конечно, перспективах.</p>
				</section>
