		...
		<div className={styles.wrapper}>
			<div className={styles.card}>
				...
				{isResultStep && (
					...
					>
						{(() => {
							if ((answers[1] === 'a' || answers[1] === 'b' || answers[1] === 'c') && answers[3] === 'a') {
								return (
							...
							if ((answers[1] === 'a' || answers[1] === 'b' || answers[1] === 'c') && answers[3] === 'b') {
								return (
									<div className={styles.resultDescription}>
										...
										<b>
											Курс:{' '}
											<a href='/courses/mobile-development/java-android' className='accent'>
										...
										<br />
										<p>
											<b>Что получите:</b> Научитесь создавать приложения под Android на Java и Kotlin. Соберете
											привлекательное портфолио из 4-х проектов, сможете решать реальные задачи Junior разработчика и
											подготовитесь к трудоустройству в IT-компанию.
										</p>
										<br />
										<b>
											Курс:{' '}
											<a href='/courses/mobile-development/mobiledev-ios' className='accent'>
										...
										<br />
										<p>
											<b>Что получите:</b> Научитесь создавать приложения для устройств Apple на языке программирования
											Swift. Создатите первое приложение прямо на занятиях. Наполните портфолио, составите резюме и
											будете полностью готовы к должности iOS-разработчик на Swift.
										</p>
										<br />
										<p>
											<strong>🎁 Бонус:</strong>
							...
							if ((answers[1] === 'a' || answers[1] === 'b' || answers[1] === 'c') && answers[3] === 'c') {
								return (
									<div className={styles.resultDescription}>
							...
							if (answers[1] === 'd' && answers[2] === 'b') {
								return (
									<div className={styles.resultDescription}>
										...
										<b>
											Курс:{' '}
											<a href='/courses/design/design-dlya-nachinayshih' className='accent'>
												Основы дизайна
											</a>
										</b>
										<br />
										<br />
										<p>
											<b>Что получите:</b> Научитесь работать в популярных графических редакторах: Photoshop,
											Illustrator, Figma и After Effects.Подготовитесь к обучению на специализированных курсах дизайна –
											графический, веб-, моушн-дизайн и прочие.
										</p>
										<br />
										<b>
											Курс:{' '}
											<a href='/courses/design/graphic-designer' className='accent'>
												Графический Дизайн
											</a>
										</b>
										<br />
										<br />
										<p>
											<b>Что получите:</b> Научитесь создавать креативный визуал, в котором нуждается бизнес. Получите
											практический опыт с первого дня обучения. Собёрете внушительное портфолио из востребованных работ
											- от рекламного баннера до айдентики бренда.
										</p>
										<br />
										<b>
											Курс:{' '}
							...
							if (answers[1] === 'd' && answers[2] === 'd') {
								return (
									<div className={styles.resultDescription}>
										...
										<b>
											Курс:{' '}
											<a href='/courses/other/pm-kurs' className='accent'>
										...
										<br />
										<p>
											<b>Что получите:</b> Научитесь управлять IT-проектом от расстановки приоритетов по задачам до
											коммуникации с клиентом и составления документации. Освоите ключевые инструменты
											проджект-менеджера, hard и soft skills. Сможете зарабатывать без навыков программирования наравне
											с разработчиками.
										</p>
										<br />
										<b>
											Курс:{' '}
											<a href='/courses/other/manager-marketplace' className='accent'>
										...
										<br />
										<p>
											<b>Что получите:</b> Изучите основы работы с крупнейшими маркетплейсами, включая Wildberries,
											Ozon, «Яндекс.Маркет», AliExpress и «СберМегаМаркет». Научитесь правильно оформлять карточки
											товаров, освоите основные принципы их продвижения и анализа эффективности на платформах. Эти
											знания позволят вам начать зарабатывать в интернете или открыть свой собственный онлайн-бизнес.
										</p>
										<br />
										<p>
											<strong>🎁 Бонус:</strong>
