...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «SMM специалист с нуля» | Обучение СММ для начинающих онлайн в ${city}`,
		description: `Запишитесь на курсы SMM в ${city} и станьте специалистом за 3 месяца! Онлайн обучение SMM с трудоустройством. Начните карьеру в сфере продвижения уже сегодня!`,
		keywords: ['Курсы SMM специалист', 'Курсы SMM специалист для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс SMM специалист в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/marketing/smm`,
		},
	};
}
