...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «iOS Разработчик» | Обучение мобильной разработке приложений на iOS в ${city}`,
		description: `Запишитесь на курсы iOS и станьте профессиональным разработчиком за 4 месяца в ${city}! Обучение с нуля, онлайн-формат, практические задания и поддержка наставников.`,
		keywords: ['Курсы iOS Разработчик', 'Курсы iOS Разработчик для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс «iOS Разработчик» | Обучение мобильной разработке приложений на iOS в ${city}`,
			description: `Запишитесь на курсы iOS и станьте профессиональным разработчиком за 4 месяца в ${city}! Обучение с нуля, онлайн-формат, практические задания и поддержка наставников.`,
			url: '/courses/mobile-development/mobiledev-ios',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс iOS Разработчик в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/mobile-development/mobiledev-ios`,
		},
	};
}
