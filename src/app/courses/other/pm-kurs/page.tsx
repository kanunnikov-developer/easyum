...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «Проджект-менеджер IT проектов» | Обучение на проектного менеджера с нуля онлайн в ${city}`,
		description: `Запишитесь на курс «Project Manager» и получите качественное обучение в сфере управления проектами. Онлайн-курсы с трудоустройством в ${city}.`,
		keywords: ['Курсы Проджект-менеджер IT проектов', 'Курсы Проджект-менеджер IT проектов для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс Проджект-менеджер IT проектов в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/other/pm-kurs`,
		},
	};
}
