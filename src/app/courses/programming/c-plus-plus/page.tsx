...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс C++: дистанционное обучение с нуля в ${city}`,
		description: `Запишитесь на курс C++ и изучите язык программирования с нуля за 5 месяцев! Дистанционное и очное обучение, помощь с трудоустройством, доступные цены в ${city}.`,
		keywords: ['Курсы C++ разработчик', 'Курсы C++ разработчик для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс C++: дистанционное обучение с нуля в ${city}`,
			description: `Запишитесь на курс C++ и изучите язык программирования с нуля за 5 месяцев! Дистанционное и очное обучение, помощь с трудоустройством, доступные цены в ${city}.`,
			url: '/courses/programming/c-plus-plus',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс C++ разработчик в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/programming/c-plus-plus`,
		},
	};
}
...
const course = {
	...
	duration: '4 месяца',
	duration_number: 4,
	price: dateStart[3].price,
	imgCourse: dateStart[3].imgCourse,
};
