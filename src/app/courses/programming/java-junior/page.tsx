...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс ❝Java Junior Веб-Разработчик❞ 6 мес. от EasyUM: онлайн и очное обучение программированию на Java в ${city}`,
		description: `Лучший курс Java разработчик с нуля. В программе: Spring, Kafka, Docker, Микросервисы. Портфолио из 7ми проектов! Онлайн или очно в 77 городах России. Стань программистом на Джаве. Сертификат и помощь в трудоустройстве в ${city}.`,
		keywords: ['КурсыJava Junior Веб-Разработчик', 'Курсы Java Junior Веб-Разработчик для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс ❝Java Junior Веб-Разработчик❞ 6 мес. от EasyUM: онлайн и очное обучение программированию на Java в ${city}`,
			description: `Лучший курс Java разработчик с нуля. В программе: Spring, Kafka, Docker, Микросервисы. Портфолио из 7ми проектов! Онлайн или очно в 77 городах России. Стань программистом на Джаве. Сертификат и помощь в трудоустройстве в ${city}.`,
			url: '/courses/programming/java-junior',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс Java Junior Веб-Разработчик в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/programming/java-junior`,
		},
	};
}
