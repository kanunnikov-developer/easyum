...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «Java с нуля до PRO» | Обучение джава программированию онлайн в ${city}`,
		description: `Запишитесь на курс «Java с нуля до PRO» и станьте профессиональным разработчиком за 8 месяцев! Обучение языку Java для начинающих онлайн, доступные цены и качественные материалы в ${city}.`,
		keywords: ['Курсы Java с нуля до PRO', 'Курсы Java с нуля до PRO для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс «Java с нуля до PRO» | Обучение джава программированию онлайн в ${city}`,
			description: `Запишитесь на курс «Java с нуля до PRO» и станьте профессиональным разработчиком за 8 месяцев! Обучение языку Java для начинающих онлайн, доступные цены и качественные материалы в ${city}.`,
			url: '/courses/programming/java-pro',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс Java с нуля до PRO в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/programming/java-pro`,
		},
	};
}
