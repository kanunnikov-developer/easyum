...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «PHP с нуля» | Обучение PHP программированию онлайн в ${city}`,
		description: `Запишитесь на курс «PHP с нуля» и станьте разработчиком за 5 месяцев! Обучение PHP с нуля, основы и продвинутые техники. Онлайн-курсы и практические занятия в ${city}.`,
		keywords: ['Курсы PHP с нуля', 'Курсы PHP с нуля для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс «PHP с нуля» | Обучение PHP программированию онлайн в ${city}`,
			description: `Запишитесь на курс «PHP с нуля» и станьте разработчиком за 5 месяцев! Обучение PHP с нуля, основы и продвинутые техники. Онлайн-курсы и практические занятия в ${city}.`,
			url: '/courses/programming/php-junior',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс PHP с нуля в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/programming/php-junior`,
		},
	};
}
