...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «Тестировщик ПО» - обучение QA тестировщика с нуля онлайн в ${city}`,
		description: `Запишитесь на курс «Тестировщик ПО с нуля за 3 месяца». Дистанционное и очное обучение, практические задания и поддержка опытных специалистов. Начните карьеру QA тестировщика сегодня в ${city}!`,
		keywords: ['Курсы Тестировщик ПО', 'Курсы Тестировщик ПО для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс «Тестировщик ПО» - обучение QA тестировщика с нуля онлайн в ${city}`,
			description: `Запишитесь на курс «Тестировщик ПО с нуля за 3 месяца». Дистанционное и очное обучение, практические задания и поддержка опытных специалистов. Начните карьеру QA тестировщика сегодня в ${city}!`,
			url: '/courses/testing/testing-qa',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс Тестировщик ПО с нуля в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/testing/testing-qa`,
		},
	};
}
