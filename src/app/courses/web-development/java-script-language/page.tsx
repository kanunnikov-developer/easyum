...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: `Курс «JavaScript с нуля»: Обучение JavaScript программированию для начинающих онлайн в ${city}`,
		description: `Запишитесь на курсы JavaScript и начните обучение с нуля за 4 месяца! Полный курс программирования на джаваскрипт для начинающих в ${city}. Онлайн-обучение и помощь в трудоустройстве!`,
		keywords: ['Курсы JavaScript с нуля', 'Курсы JavaScript с нуля для начинающих'],
		authors: [{ name: 'EasyUM' }],
		creator: 'EasyUM',
		...
		openGraph: {
			title: `Курс «JavaScript с нуля»: Обучение JavaScript программированию для начинающих онлайн в ${city}`,
			description: `Запишитесь на курсы JavaScript и начните обучение с нуля за 4 месяца! Полный курс программирования на джаваскрипт для начинающих в ${city}. Онлайн-обучение и помощь в трудоустройстве!`,
			url: '/courses/web-development/java-script-language',
			type: 'website',
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `Курс JavaScript с нуля в ${city} — EasyUM`,
				},
			],
			locale: 'ru_RU',
			siteName: 'EasyUM',
		...
		alternates: {
			canonical: `/courses/web-development/java-script-language`,
		},
	};
}
